...
LRESULT CALLBACK Framework::WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_KEYDOWN:
        {
            ...
            InputEvent* pEvent = new InputEvent( InputDeviceType_Keyboard, InputState_Pressed, wParam, 0, 0 );
    ...
    case WM_KEYUP:
        {
            ...
            InputEvent* pEvent = new InputEvent( InputDeviceType_Keyboard, InputState_Released, wParam, 0, 0 );
            pFramework->m_pGameCore->QueueEvent( pEvent );
        }
        return 0;
    ...
    case WM_MOUSEMOVE:
        {
            ...
            InputEvent* pEvent = new InputEvent( InputDeviceType_Mouse, InputState_Moved, -1, (float)x, (float)y );
            pFramework->m_pGameCore->QueueEvent( pEvent );
        }
        return 0;
    ...
    case WM_LBUTTONDOWN:
        {
            ...
            InputEvent* pEvent = new InputEvent( InputDeviceType_Mouse, InputState_Pressed, 0, (float)x, (float)y );
            pFramework->m_pGameCore->QueueEvent( pEvent );
        }
        return 0;
    ...
    case WM_LBUTTONUP:
        {
            ...
            InputEvent* pEvent = new InputEvent( InputDeviceType_Mouse, InputState_Released, 0, (float)x, (float)y );
            pFramework->m_pGameCore->QueueEvent( pEvent );
        }
        return 0;
    ...
    case WM_RBUTTONDOWN:
    {
        ...
        InputEvent* pEvent = new InputEvent(InputDeviceType_Mouse, InputState_Pressed, 1, (float)x, (float)y);
        pFramework->m_pGameCore->QueueEvent(pEvent);
    }
    return 0;
    ...
    case WM_RBUTTONUP:
    {
        ...
        InputEvent* pEvent = new InputEvent(InputDeviceType_Mouse, InputState_Released, 1, (float)x, (float)y);
        pFramework->m_pGameCore->QueueEvent(pEvent);
    }
    return 0;
